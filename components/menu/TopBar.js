        ...
        <div className="flex items-center flex-grow p-8 mb-4">
          <div className="p-3 flex">
            <div className="flex items-center">
              ...
              <span className="ml-3 text-sm font-semibold">San Francisco, California</span>
            ...
            <div className="flex items-center ml-6">
              ...
              <span className="ml-3 text-sm font-semibold">Pick up</span>
              <svg className="w-4 h-4 ml-2" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.175 10L8 13.7116L11.825 10L13 11.1482L8 16L3 11.1482L4.175 10Z" fill="black" />
                <path d="M11.825 6L8 2.28841L4.175 6L3 4.85175L8 0L13 4.85175L11.825 6Z" fill="black" />
              </svg>
            ...
            <div className="flex items-center ml-6">
              ...
              <span className="ml-3 text-sm font-semibold">Best deals</span>
              <svg className="w-4 h-4 ml-2" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.175 10L8 13.7116L11.825 10L13 11.1482L8 16L3 11.1482L4.175 10Z" fill="black" />
                <path d="M11.825 6L8 2.28841L4.175 6L3 4.85175L8 0L13 4.85175L11.825 6Z" fill="black" />
              </svg>
          ...
          <div className="flex flex-grow h-12 ml-12">
            ...
            <button className="flex items-center justify-center w-12 h-12 rounded-xl bg-purple-900 ml-4">
            ...
            <button className="flex items-center justify-center w-12 h-12 rounded-xl bg-red-500 ml-4">
