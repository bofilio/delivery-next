...
const SideBar = () => {
    return (
        ...
        <div className="mt-12 ">
          <Link href="#">
            <div className="flex items-center p-4 bg-purple-900 rounded-xl cursor-pointer">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
              </svg>
              <span className="lg:block hidden ml-6 text-gray-200 font-bold">Home</span>
            </div>
          </Link>

          <div className="p-4">
            <Link href="#">
              <div className="flex items-center rounded-xl mb-8 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                </svg>
                <span className="lg:inline hidden ml-6 text-gray-500">
                  Explore
                </span>
              </div>
            </Link>
            <Link href="#">
              <div className="flex items-center  rounded-xl mb-8 cursor-pointer">
                ...
                <span className="lg:inline hidden ml-6 text-gray-500">Favourite</span>
              </div>
            </Link>
            <Link href="#">
              <div className="flex items-center  rounded-xl mb-8 cursor-pointer">
                ...
                <span className=" lg:inline hidden ml-6 text-gray-500">Orders</span>
              </div>
            </Link>
            <Link href="#">
              <div className="flex items-center  rounded-xl mb-8 cursor-pointer relative">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className=" lg:inline hidden ml-6 text-gray-500">Messages</span>
                {/*Badge*/}
                <span className="lg:flex hidden justify-center items-center w-6 h-6 text-gray-200 text-xs right-0 absolute rounded-full bg-purple-900">2</span>
              </div>
            </Link>
            <Link href="#">
              <div className="flex items-center  rounded-xl cursor-pointer">
                ...
                <span className="lg:inline hidden ml-6 text-gray-500">Setings</span>
              </div>
            </Link>
