    ...
    return (
        <div className="flex flex-col lg:w-80 w-full flex-shrink-0 lg:p-4 p-0 mb-8 lg:mb-0  ">
            ...
            <div className="mt-4 flex items-center justify-between">
                ...
                <span className="text-xs text-primary bg-tr-primary  rounded font-semibold py-1 px-2">Free delivery</span>
            </div>
            <div className="flex items-center space-x-4 mt-2">
                ...
                <div className="flex items-center space-x-2 text-xs text-gray">
                    <svg className="w-4 h-4 text-gray" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
