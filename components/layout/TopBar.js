...
const TopBar = () => {
    return (
        <div className="flex items-center">
            <ModalProvider>
                <OpenModal className="lg:hidden flex items-center justify-center w-12 h-12 rounded-xl bg-primary lg:ml-4 ml-0 p-3">
                ...
                <Modal className="absolute w-full h-full top-0 left-0">
                    <div className=" relative flex flex-col bg-white shadow-lg z-50 p-8 w-full h-full ">
                        ...
                        <CloseModal className="lg:hidden flex items-center justify-center w-12 h-12 rounded-xl bg-primary  p-3">
                            <svg className="h-4 w-4 text-light" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
