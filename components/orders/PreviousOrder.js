        ...
        <div className="p-4 flex flex-col justify-between lg:w-80 w-full text-light lg:mr-8 mr-0 lg:mb-8 mb-6 rounded-2xl">
            <div className="flex flex-col">
                <div className="flex justify-between items-center">
                    ...
                    <span className="px-2 py-1 bg-tr-success text-xs text-success rounded-md font-semibold"> Completed</span>
                </div>
                <div className="flex items-center space-x-4 text-xs text-gray mt-3">
            ...
            <ModalProvider>
                <div className="flex items-center justify-center space-x-4 mt-6 text-sm ">
                    <OpenModal className="flex-grow px-4 text-center py-2 bg-secondary text-light rounded-lg  font-bold">
                        Details
                    </OpenModal>
