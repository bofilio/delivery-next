            ...
            <div className="flex-grow flex flex-col justify-between p-4">
                ...
                <div className="mt-6 flex flex-col space-y-6  text-xs px-2">
                    <div className="flex items-center space-x-4 ">
                        <span className="text-gray-normal p-1"><ClockIcon className="w-5 h-5 text-gray-normal" /></span>
                        <span className="text-dark ">Delivered</span>
                    </div>
                    <div className="flex items-center  justify-between">
                        <div className="flex items-center space-x-4">
                            <span className="text-gray-normal bg-transparent-secondary p-1"> <CheckIcon className="w-5 h-5 text-secondary" /> </span>
