    ...
    return (
        <div className="mt-12">
            ...
            <div className=" relative pb-12">
                ...
                <div className=" bg-light rounded-2xl absolute p-4 lg:p-6 bottom-0 left-1/2 transform -translate-x-1/2 ">
            ...
            <div className="mt-8 lg:space-x-6 space-x-0 space-y-6 flex flex-col lg:flex-row">
                ...
                <div className=" space-y-3 lg:w-1/2 w-full">
                    ...
                    <p className="text-gray" >
                        It is one of the most iconic and well-recognizable fast food restaurants
                        out there which offers really amazing food and drinks.
                    </p>
                </div>
                {/**tags */}
                <div className="flex flex-wrap items-center lg:w-1/2 w-full">
                    <Badge color="primary" className="py-2 px-3 text-xs md:text-base rounded-lg font-semibold mr-4 mb-4">Free delivery</Badge>
                    <Badge color="secondary" className="py-2 px-3 text-xs md:text-base rounded-lg font-semibold mr-4 mb-4">Buy 2 get 1 free</Badge>
                    <Badge color="success" className="py-2 px-3 text-xs md:text-base rounded-lg font-semibold mr-4 mb-4">Open at 12 am</Badge>
                </div>
            </div>
            {/**info */}
            <div className="mt-2 flex flex-wrap items-center ">
                <div className="flex items-center space-x-2 text-gray text-xs md:text-base mr-6 mb-4">
                    <StarIcon className="text-tertiary w-4 h4" />
                    <p> <span className="text-dark font-bold">4,8</span>(1,873)</p>
                </div>

                <div className="flex items-center space-x-2 text-xs md:text-base text-gray mr-6 mb-4">
            ...
            <TabulationProvider>
                <div className="flex items-center overflow-x-auto  text-xs space-x-4 pb-2 my-6">
                    ...
                    <Tab id={2} title=" burgers (6)" className="py-2 px-3 flex-shrink-0"/>
                    <Tab id={3} title=" Fries (4)" className="py-2 px-3 flex-shrink-0"/>
                    <Tab id={4} title=" Drinks (29)" className="py-2 px-3 flex-shrink-0"/>
