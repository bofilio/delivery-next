        ...
        <div className="flex lg:flex-row flex-col min-h-screen">
            ...
            <div className="flex-grow flex lg:min-h-screen lg:justify-center justify-items-start lg:p-0 p-12 items-center">
                <div className="max-w-xl flex-grow">
                    <div className="mb-12">
                        <h1 className="text-3xl text-gray-900 text-left font-bold mb-3">
                            Create an account
                        </h1>
                        <span className="text-xl text-gray-500">Plese create an account to
                        </span>
                    </div>

                    <form className="flex flex-col">
                        <InputBlock label="FULL NAME" default_value="Mark Clarke"
                            icon={
                        ...
                        <div className="text-center text-gray-500">
                            ...
                            <Link href="/auth/signin">
                                <a className="text-red-500 font-bold"> Sign In</a>
                            </Link>
                        </div>
                    </form>
                </div>
